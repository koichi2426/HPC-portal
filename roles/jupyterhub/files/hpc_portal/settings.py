...
HPC_OLLAMA_ALLOWED_MEMORY = _json_list(
    "HPC_OLLAMA_ALLOWED_MEMORY",
    ["16G", "24G", "32G", "40G", "48G", "56G", "64G", "80G", "96G", "112G"],
)
HPC_OLLAMA_DEFAULT_CPUS = _value("HPC_OLLAMA_DEFAULT_CPUS", "8")
HPC_OLLAMA_DEFAULT_MEMORY = _value("HPC_OLLAMA_DEFAULT_MEMORY", "40G")
HPC_OLLAMA_GPUS = _value("HPC_OLLAMA_GPUS", "0")
...
HPC_OLLAMA_ALLOWED_MAX_LOADED_MODELS = _json_list(
    "HPC_OLLAMA_ALLOWED_MAX_LOADED_MODELS", [1, 2]
)
HPC_OLLAMA_DEFAULT_MAX_LOADED_MODELS = _value(
    "HPC_OLLAMA_DEFAULT_MAX_LOADED_MODELS", "1"
)
